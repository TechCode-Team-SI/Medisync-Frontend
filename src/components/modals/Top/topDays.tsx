          ...
          datalist.map((Day) => (
            ...
            >
              <div className='flex flex-col gap-1 grow'>
                <CardTitle className='font-roboto font-bold text-[18px] text-green-400'>{Day.weekday}</CardTitle>
                <span className='font-roboto font-medium text-[16px] text-gray-500'>
                  {Day.requests} {Day.requests === 1 ? 'cita' : 'citas'}
                </span>
              </div>
