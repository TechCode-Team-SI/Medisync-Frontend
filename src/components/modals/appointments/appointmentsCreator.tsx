...
import { CreatePrivateAppointmentForm } from 'src/screens/appointments/createPrivateAppointmentsForm';
...
export const AppointmentCreator = ({ userId }: AppointmentCreatorProps) => {
  ...
  return (
    <DialogContent>
      <div className='flex w-full flex-col gap-4 p-4 bg-white scrollbar-edit overflow-auto'>
        <Stepper
          initialStep={0}
          steps={steps}
          styles={{
