      ...
      <div className='relative w-full h-full flex flex-col rounded-b-lg bg-white px-10 py-6 '>
        <div className='flex flex-col w-full justify-center space-x-2'>
          <div className='flex  flex-col'>
            ...
            <Input id='name' className='w-full h-11 rounded-2 font-roboto text-base' />
            ...
            <div className='flex flex-row items-center justify-center space-x-2'>
              <Input id='description' className='w-full  h-11 rounded-3 font-roboto text-base line-clamp-5 ' />
