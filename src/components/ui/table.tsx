...
const Table = React.forwardRef<HTMLTableElement, TableProps>(({ className, containerClassName, ...props }, ref) => (
  <div className={cn('relative w-full overflow-auto scrollbar-edit', containerClassName)}>
...
const TableHead = React.forwardRef<HTMLTableCellElement, React.ThHTMLAttributes<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => (
    <th
      ref={ref}
      className={cn(
        'h-[35px] px-4 text-center align-middle font-montserrat font-bold [&:has([role=checkbox])]:pr-0 dark:text-slate-400',
        className,
      )}
      {...props}
    />
...
const TableCell = React.forwardRef<HTMLTableCellElement, React.TdHTMLAttributes<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => (
    <td
      ref={ref}
      className={cn('h-[35px] align-middle text-center [&:has([role=checkbox])]:pr-0', className)}
      {...props}
    />
  ),
);
