...
const CalendarExpand = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' className='h-[59px] w-[54px]' fill='none' {...props}>
    <path
      fill={props.fill}
