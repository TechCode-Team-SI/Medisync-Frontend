    ...
    <div className='w-full h-screen flex flex-row items-center bg-green-400 relative'>
      <Card className='h-full w-full flex flex-col px-8 sm:px-9 lg:px-10 pt-8 sm:pt-9 lg:pt-10 bg-green-600 border-none rounded-none rounded-l-xl'>
        ...
        <Card className='bg-white w-full h-full rounded-b-none overflow-auto scrollbar-edit flex flex-col p-6 pb-0 sm:p-8 sm:pb-0 lg:p-10 lg:pb-0 space-y-5'>
          ...
          <div>
            <TableBody className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4'>
              {invoices.map((Persona) => (
                <TableRow className='border-b-0' key={Persona.Persona}>
                  <TableCell>
                    <Card className='bg-green-50 shadow-md min-h-[309px] max-h-[309px] w-[227px] flex flex-col justify-around rounded-none border-spacing-0 border-0'>
                      <div>
                        <CardHeader className='bg-green-400 h-32 p-0 flex justify-center items-center rounded-none border-spacing-0'>
                          <Specialties fill='white' className='h-24 w-24' />
                        </CardHeader>
