                    ...
                    <TableCell className='flex justify-center items-center'>
                      <Dialog>
                        <DialogTrigger asChild>
                          <Switch className='fill-current h-5 w-12 cursor-pointer' />
                        </DialogTrigger>
                        <AlertExclamation title={'¿Desea Deshabilitar la Publicación ?'} />
                      </Dialog>
                    </TableCell>
                  </TableRow>
                ))}
