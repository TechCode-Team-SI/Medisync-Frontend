...
export function AssignAgendaEdit() {
  return (
        ...
        <Card className='bg-white w-full h-full rounded-b-none overflow-auto scrollbar-edit flex flex-col p-6 pb-0 sm:p-8 sm:pb-0 lg:p-10 lg:pb-0 gap-5'>
          <div className='flex flex-col mb-6'>
            ...
            <div className='flex h-max'>
              <Button className='  bg-green-600 border-b-2 w-full flex justify-between'>
                <Label className=''>Seleccionar Agenda</Label>
                <Dialog>
                  <DialogTrigger asChild>
                    <GrCheckmark className='fill-current text-green-400 h-4 w-4 cursor-pointer' />
                  </DialogTrigger>
                  <SeeAgenda />
                </Dialog>
              </Button>
          ...
          <div className='flex flex-col mb-6'>
            <CardTitle className=' text-green-400 font-montserrat font-bold text-[15px] text-left mb-6'>
              DIAS NO LABORABLES ADICIONALES
            </CardTitle>
                    ...
                    >
                      ...
                      <TableCell className='flex justify-center items-center'>
                        ...
                        <Dialog>
                          ...
                          <AlertExclamation title='¿Desea Eliminar esta Agenda?' />
                        </Dialog>
                      </TableCell>
                    </TableRow>
                  ))}
